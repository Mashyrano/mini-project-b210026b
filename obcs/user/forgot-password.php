...
<head>
    ...
    <title>Forgot Password | Online Certificate System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                 <h3 style="font-weight: bold;color: rgb(53,53,79)">Online Certificate System</h3><hr />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: rgb(53,53,79)">Forgot Password</h1>
                                            </div>
                                        </div>
                                    </div>
