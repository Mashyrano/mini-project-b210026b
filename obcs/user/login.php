...
<head>
    ...
    <title>Login | Online Certificate System</title>
            ...
            <div class="login-form-area mg-t-30 mg-b-40">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form class="adminpro-form" method="post" name="login" style="background-color: lightgrey;">
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: rgb(53,53,79)">User</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
