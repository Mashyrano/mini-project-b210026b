                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <hr />
                                        <p align="left">This is to certify that the following information has been taken from the original record of Death.</p>
                                       
<?php
$vid=$_GET['viewid'];
$sql="SELECT dthapplication.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  dthapplication join  tbluser on dthapplication.UserID=tbluser.ID where dthapplication.ID=:vid and  dthapplication.Status='Verified'";
