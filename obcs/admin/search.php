...
<head>
    ...
    <title>Search | Online Certificate System</title>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post" action="death-birth-search.php">
                                                     
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-5">
                                                                    <label class="login2 pull-right pull-right-pro">Search by Application Number / Name</label>
                                                                </div>
                                                                <div class="col-lg-7">
