...
<head>
    ...
    <title>All Application | Online Certificate System</title>
...
<h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?></h4>
                                        <h4 style="margin-top: 15px;">Death Certicates</h4>
...
$sql="SELECT * from dthapplication where date(Dateofapply) between '$fdate' and '$tdate'";
