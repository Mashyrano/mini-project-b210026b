...
$sql= "update dthapplication set Status=:status,Remark=:remark where ID=:vid";
...
$sql="SELECT dthapplication.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  dthapplication join  tbluser on dthapplication.UserID=tbluser.ID where dthapplication.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<?php  if($row->Status=='Verified'): ?>
    ...
    <a href="download-death-certificate.php?cid=<?php  echo $row->ApplicationID;?>" class="btn btn-danger">
