...
<head>
    ...
    <title>Dashboard | Online Certificate System</title>
...
$sql ="SELECT ID from dthapplication where Status is null ";
$query2 = $dbh -> prepare($sql);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);

$totalnewapp=$query->rowCount() + $query2->rowCount();
?>  <div class="col-lg-4">
...
$totalverapp=$query->rowCount() + $query2->rowCount();
?>
...
$sql ="SELECT ID from dthapplication where Status='Rejected' ";
$query2 = $dbh -> prepare($sql);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);

$totalrejapp=$query->rowCount() + $query2->rowCount();
?><div class="col-lg-4">
...
$sql ="SELECT ID from dthapplication ";
$query2 = $dbh -> prepare($sql);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);

$allpps=$query->rowCount() + $query2->rowCount();
?><div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
